...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('ianm/online-guests', function () {
  (0,_common_registerWidget__WEBPACK_IMPORTED_MODULE_1__["default"])((flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default()));
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('ianm-online-guests').registerPermission({
    permission: 'viewOnlineGuests',
    icon: 'fas fa-eye',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('ianm-online-guests.admin.permissions.view_online_guests_label'),
    allowGuest: true
  }, 'view').registerSetting({
    setting: 'ianm-online-guests.online-duration',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('ianm-online-guests.admin.settings.online_duration_label'),
    type: 'number',
    min: 0
  }).registerSetting({
    setting: 'ianm-online-guests.cache-duration',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('ianm-online-guests.admin.settings.cache_duration_label'),
    type: 'number',
    min: 0
  });
});
...
/***/ "./src/common/components/OnlineGuestsWidget.tsx":
/*!******************************************************!*\
  !*** ./src/common/components/OnlineGuestsWidget.tsx ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (/* binding */ OnlineGuestsWidget)
/* harmony export */ });
...
var OnlineGuestsWidget = /*#__PURE__*/function (_Widget) {
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(OnlineGuestsWidget, _Widget);
  function OnlineGuestsWidget() {
    return _Widget.apply(this, arguments) || this;
  }
  var _proto = OnlineGuestsWidget.prototype;
  ...
  _proto.title = function title() {
    return flarum_common_utils_extractText__WEBPACK_IMPORTED_MODULE_3___default()(flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('ianm-online-guests.forum.widget.title'));
  };
  _proto.content = function content() {
    var guestCount = flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default().forum.attribute('onlineGuests');
    return m("div", {
      className: "IanM-OnlineGuestsWidget-content"
    }, m("span", {
      className: "IanM-OnlineGuestsWidget-guestCount"
    }, guestCount), m("span", {
      className: "IanM-OnlineGuestsWidget-description"
    }, flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('ianm-online-guests.forum.widget.guests_online', {
      count: guestCount
    })));
  };
  return OnlineGuestsWidget;
}((flarum_extensions_afrux_forum_widgets_core_common_components_Widget__WEBPACK_IMPORTED_MODULE_2___default()));
...
/* harmony import */ var _components_OnlineGuestsWidget__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/OnlineGuestsWidget */ "./src/common/components/OnlineGuestsWidget.tsx");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(app) {
  new (flarum_extensions_afrux_forum_widgets_core_common_extend_Widgets__WEBPACK_IMPORTED_MODULE_0___default())().add({
    key: 'onlineGuests',
    component: _components_OnlineGuestsWidget__WEBPACK_IMPORTED_MODULE_1__["default"],
    isDisabled: function isDisabled() {
      return app.forum.attribute('onlineGuests') === undefined;
    },
    isUnique: true,
    placement: 'end',
    position: 2
  }).extend(app, 'ianm-online-guests');
}
